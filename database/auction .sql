...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2021 at 06:43 PM
...
(1, 1, 'product-1-picture-1.jpg'),
(2, 1, 'product-1-picture-2.jpg'),
(3, 1, 'product-1-picture-3.jpg'),
(4, 3, 'product-2-picture-1.jpg'),
(5, 3, 'product-2-picture-2.jpg'),
(7, 4, 'product-3-picture-1.jpg'),
(8, 4, 'product-3-picture-3.jpg'),
(9, 5, 'product-4-picture-1.jpg'),
(10, 5, 'product-4-picture-2.jpg'),
(11, 6, 'product-5-picture-1.jpg'),
(12, 6, 'product-5-picture-2.jpg'),
(13, 6, 'product-5-picture-3.jpg'),
(14, 7, 'product-6-picture-1.jpg'),
(15, 7, 'product-6-picture-2.jpg'),
(16, 7, 'product-6-picture-3.jpg'),
(17, 8, 'product-7-picture-1.jpg'),
(18, 8, 'product-7-picture-2.jpg'),
(19, 8, 'product-7-picture-3.jpg'),
(20, 9, 'product-8-picture-1.jpg'),
(21, 9, 'product-8-picture-2.jpg'),
(22, 9, 'product-8-picture-3.jpg');
...
(61, 'joel.tafilaj', 'tafilaj82@gmail.com', '66306336336166623264613137623439396238663436316530383363313830323533306431653465', 1, 'b40d03386fb8fd7dc6ca9c6f8d680dfc58d60fd6ea72c63f573cc5bfbb09695746a849c91517c235cdfeaca4e734208f184bc08aae06797748988e95928f80b1', 'costumer', 0),
(76, 'seminar', 'joeltafilaj4@gmail.com', '32653931656237363231306238663762643361623863366633653466386639386236343665623034', 1, '258e2f9ba09c3564e1abcb239f97a94249c022f881753b284deacf361dd328ce029ef4f6e01cff69abe7c9a37da43ae99c9b05648d37ff7da7dd192b8cc4ce79', 'salessman', 0);
...
ALTER TABLE `product`
  ...
  ADD KEY `salessman_id` (`salessman_id`),
...
--
ALTER TABLE `salessman`
  MODIFY `salessman_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
ALTER TABLE `product`
  ...
  ADD CONSTRAINT `salessman_id` FOREIGN KEY (`salessman_id`) REFERENCES `salessman` (`salessman_id`) ON DELETE CASCADE;
