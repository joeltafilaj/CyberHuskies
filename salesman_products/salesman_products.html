...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="salesman_products.css">
    <title>Auction</title>
...
<div class="products-from-category-container">
    <div class="products-from-category">
        <div class="product">
            <div id="salesman_prod" class="carousel carousel-dark slide carousel-fade big-img" data-interval="false">
                <div class="carousel-inner">

                    <div class="carousel-item active">
                        <img src="inc/pictures/products.jpg" class="img-fluid" alt="Image Carousel">
                    </div>
                    <div class="carousel-item">
                        <img src="inc/pictures/products2.jpg" class="img-fluid" alt="Image Carousel">
                    </div>
                    <div class="carousel-item">
                        <img src="inc/pictures/products3.jpg" class="img-fluid" alt="Image Carousel">
                    </div>
                </div>
                <button class="carousel-control-prev" type="button" data-bs-target="#salesman_prod" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#salesman_prod" data-bs-slide="next">
            ...
            <div class="prod-details">
                <div class="prod-name"><b>Product name: </b>Ancient painting from East</div>
                <div><b>Available at auction starting from: </b>15/06/2021</div>
                <div><b>Product is at auction until: </b>15/06/2021</div>
                <div class="min-price"><b>Reserve price: </b> &euro;5000</div>
                <div><b>Category: </b>vehicles</div>
                <div><b>Product description: </b>description description description description description description</div>
        ...
        <div class="product">
            <div id="salesman_prod2" class="carousel carousel-dark slide carousel-fade big-img" data-interval="false"
            data-bs-touch="false">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="inc/pictures/products.jpg" class="img-fluid" alt="Image Carousel">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#salesman_prod2" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#salesman_prod2" data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
            </div>
