...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="upload_product.css">
    <title>Auction</title>
...
<div class="product-input-container">
    <div class="product-inputs">
        <form method="POST" action="upload_product_test.php" enctype="multipart/form-data">
            ...
            <div class="product-input">
                ...
                <input type="number" name="str_price_input" id="str_price_input" required>
            </div>
            

            <div class="product-input">
                <label for="avl_from_input">Avalilable for auction from:</label>
                <input type="datetime-local" name="avl_from_input" id="avl_from_input" required>
            </div>
            

            <div class="product-input">
                <label for="avl_unt_input">Available at auction until:</label>
                <input type="datetime-local" name="avl_unt_input" id="avl_unt_input" required>   
            </div>
            

            <div class="product-input">
                <label for="desc_input">Product description:</label>
                <textarea name="desc_input" id="desc_input" rows="10" required style="resize: none;"></textarea>
            </div>
            

            <div class="product-input">
                <label for="cat_input">Choose category:</label>
                <select name="cat_input" id="cat_input" required>
            ...
            <div class="product-input">
                <label for="photo_input">Upload photo:</label>
                <div class="add-photo">
                    <button type="button" onclick="addPhoto()"><i class="fas fa-plus"></i> Add photo</button>
                </div>
                <input type="file" name="photo_input" id="photo_input" required>
            </div>

            <div class="publish-btn-container">
                <button type="submit" name="publish-product">Publish product</button>
            </div>
        </form>
    </div>
</div>
    ...
    function addPhoto() {
        ...
        file_input.setAttribute("name", "input2");
        document.getElementsByClassName("product-input")[6].appendChild(file_input);
    }
    </script>
</body>
